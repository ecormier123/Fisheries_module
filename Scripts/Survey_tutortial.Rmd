...
A. Your job is to design an annual trawl survey for Dusky Scallop Shark (*Dustious maximus*; Figure \@ref(fig:nafo-plt)). The survey occurs June when the stock is spawning.
...
4. How many survey stations would you recommend?
...
iv.   You can change the number of simulations run on line 100.
      - I suggest trying 1, 4, and 250 (this will be slow!) to see if/how your opinion changes with more realizations of your data.
...
parameters <- data.frame(Parameter = c("Number of Tows ", "Biomass distribution",
                                       "Total Biomass", "Catchability","Area swept by a tow",
