...
4. You can also 'simulate' different biomass distributions to see if this changes you opinion on either the stratification scheme or the number of stations you need.
    ...
    c. The "Depth" option also has an underlying 'random field' which sets the pattern for each simulation
        ...
        - As depths increase the biomasses will be lower than expected
