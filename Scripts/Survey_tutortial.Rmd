...
# Survey Tutorial Questions to Consider

1. How does increasing the number of tows influence the accuracy and the precision of the results

  - Consider the tradeoffs between the number of tows and accuracy and precision of the survey results with logistical constraints of running a survey
