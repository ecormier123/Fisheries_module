...
funs <- c("https://raw.githubusercontent.com/Mar-Scal/Assessment_fns/master/Maps/pectinid_projector_sf.R",
          ...
          "https://raw.githubusercontent.com/Dave-Keith/Fisheries_module/master/Scripts/Functions/post.plt.R",
          "https://raw.githubusercontent.com/Dave-Keith/Fisheries_module/master/Scripts/Functions/exploit.ggplt.R",
          "https://raw.githubusercontent.com/Dave-Keith/Fisheries_module/master/Scripts/Functions/fit.plt.R",
          "https://raw.githubusercontent.com/Dave-Keith/Fisheries_module/master/Scripts/Functions/diag.plt.R",
          "https://raw.githubusercontent.com/Dave-Keith/Fisheries_module/master/Scripts/Functions/biomass.plt.R",
...
gr.mn <- 1.4
E.mn  <- 0.15
B <- 100000 # The initial B
R.mn <- 25000 # The average number of recruits over time period
...
# Run the model, see the function for an explanation of all the model options.
run_model(mod.dat = mod.dat, direct = direct,fig="pdf",
          jags.model = "models/delay_difference_model_base.bug",
          nchains=6,niter = 1500,nburn = 1000)

plot(DD.out$mean$R ~ mod.actual$recruits)
