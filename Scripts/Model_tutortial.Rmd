...
req.packages <- c("tidyverse","lubridate","plotly","sf","sp","data.table","units","cowplot","knitr",'concaveman',
                  ...
                  "rnaturalearthdata","raster","rgdal","RStoolbox","pals","ggnewscale","ggspatial",'devtools','rlist','matlab')
...
parameters <- data.frame(Parameter = c("Number of Tows ", 
                                       "Catchability",
                                       "Area swept by a tow",
